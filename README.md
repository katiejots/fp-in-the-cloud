...
* Install the [RHC Client tools](https://www.openshift.com/developers/rhc-client-tools-install) (Git and Ruby are dependencies for this; the link has information on how to install on various systems).

* Install PostgreSQL 9.2 or above (Optional; install if you want to be able to test your app locally. Otherwise, you can push to the cloud and see your results there.) Make sure you can connect to a running instance of the database with the `psql` command.
